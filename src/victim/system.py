...
class System_Identify_Attack_Chance():
	...
	def train_mechanism_A(self, counter_bar = 10, td_bar = 0.05, max_victim_N = 200, ae_episodes_num = 1):
		...
		while True:
			...
			if self.victim.MEM.__len__() >= MEMORY_SIZE:
				...
				# Obtain Embedding
				Z, Z_target = self.ae._embedding_batch(self.victim.MEM, MEM_target)
...
if __name__ == "__main__":
	...
	''' System_Identify_Attack_Chance -- train_mechanism_A '''
	system = System_Identify_Attack_Chance(ae_object, victim_args_dqn, victim_type="DQN")
	print("\n ... Pre-Train ..")
	system.train(10)
	print("\n ... Develop ..")
	system.train_mechanism_A(10)


	# ''' System_Identify_Attack_Chance -- train_mechanism_B '''
	# system = System_Identify_Attack_Chance(ae_object, victim_args_vpg, victim_type="VPG")
	# print("\n ... Pre-Train ..")
	# system.train(10)
	# print("\n ... Develop ..")
	# system.train_mechanism_B(1.0, 400)
